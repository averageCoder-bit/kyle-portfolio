            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  ...
                  className="rounded-md bg-black px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-neutral-800"
                >
                  View CV
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-md border border-neutral-300 px-6 py-3 text-sm font-medium text-black transition-colors hover:border-black"
                >
                  GitHub
                </a>
              </div>
